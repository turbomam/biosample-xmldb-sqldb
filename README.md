...
- _This is a replacement for https://github.com/turbomam/biosample-basex (which required a more complicated system setup and used SQLite as an intermediary between XML and Postgres)_
